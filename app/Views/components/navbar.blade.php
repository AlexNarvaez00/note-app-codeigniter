                ...
                <ul class="navbar-item flex-row ms-lg-auto ms-0">
                        ...
                        <li class="nav-item dropdown language-dropdown">
                                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <?= img('cork/src/assets/img/1x1/us.svg', false, ['class' => 'flag-width', 'alt' => 'flag']) ?>
                                </a>
                                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                                        ...
                                        <a class="dropdown-item d-flex" href="javascript:void(0);">
                                                <?= img('cork/src/assets/img/1x1/tr.svg', false, ['class' => 'flag-width', 'alt' => 'flag']) ?>
                                                <span class="align-self-center">&nbsp;Turkey</span>
                                        </a>
                                        <a class="dropdown-item d-flex" href="javascript:void(0);">
                                                <?= img('cork/src/assets/img/1x1/br.svg"', false, ['class' => 'flag-width', 'alt' => 'flag']) ?>
                                                <span class="align-self-center">&nbsp;Brazil</span>

                                        </a>
                                        <a class="dropdown-item d-flex" href="javascript:void(0);">
                                                <?= img('cork/src/assets/img/1x1/in.svg"', false, ['class' => 'flag-width', 'alt' => 'flag']) ?>
                                                <span class="align-self-center">&nbsp;India</span></a>
                                        <a class="dropdown-item d-flex" href="javascript:void(0);">
                                                <?= img('cork/src/assets/img/1x1/de.svg"', false, ['class' => 'flag-width', 'alt' => 'flag']) ?>
                                        ...
                                        <div class="notification-scroll">
                                                <div class="dropdown-item">
                                                        <div class="media server-log">
                                                                <?= img('cork/src/assets/img/profile-16.jpeg"', false, ['class' => 'img-fluid me-2', 'alt' => 'avatar']) ?>
                                                ...
                                                <div class="dropdown-item">
                                                        <div class="media ">
                                                                <?= img('cork/src/assets/img/profile-15.jpeg"', false, ['class' => 'img-fluid me-2', 'alt' => 'avatar']) ?>
                                                                <div class="media-body">
                                                                        <div class="data-info">
                                                ...
                                                <div class="dropdown-item">
                                                        <div class="media file-upload">
                                                                <?= img('cork/src/assets/img/profile-21.jpeg"', false, ['class' => 'img-fluid me-2', 'alt' => 'avatar']) ?>
                                                                <div class="media-body">
                                                                        <div class="data-info">
                                ...
                                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="avatar-container">
                                                <div class="avatar avatar-sm avatar-indicators avatar-online">
                                                        <?= img('cork/src/assets/img/profile-30.png', false, ['class' => 'rounded-circle', 'alt' => 'avatar'])  ?>
                                                </div>
                                        </div>
                                </a>
