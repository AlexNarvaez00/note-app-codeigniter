...
<form action="<?= url_to('Profile::update/$1', auth()->getUser()->id) ?>" method="POST">
 <?= csrf_field() ?>
          ...
          <div class="row">
           <div class="col-md-6">
            <div class="form-group">
             ...
             <input type="text" class="form-control mb-3" id="fullName" placeholder="Name" value="<?= auth()->getUser()->username ?>">
            </div>
           </div>
           ...
           <div class="col-md-6">
            <div class="form-group">
             ...
             <input type="text" class="form-control mb-3" id="profession" placeholder="Designer" value="<?= $profile['workstation']  ?>">
            </div>
           </div>
           <!--
          <div class="col-md-6">
...
-->
           <div class="col-md-6">
            <div class="form-group">
             ...
             <input type="text" class="form-control mb-3" id="phone" placeholder="Write your phone number here" value="<?= $profile['cellphone']  ?>">
            </div>
           </div>
           <div class="col-md-6">
            <div class="form-group">
             <label for="email">Email</label>
             <input type="text" class="form-control mb-3" id="email" placeholder="Write your email here" value="<?= auth()->getUser()->getEmail() ?>">
            </div>
           </div>
           <div class="col-md-6">
            <div class="form-group">
