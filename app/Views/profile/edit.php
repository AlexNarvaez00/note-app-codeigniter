          ...
          <div class="row">
           ...
           <div class="col-md-6">
            <div class="form-group">
             ...
             <input type="password" class="form-control mb-3" name="password" id="password" placeholder="Write your password here" value="">
            </div>
           </div>
           <div class="col-md-6">
            <div class="form-group">
             <label for="email">Confirm password</label>
             <input type="password" class="form-control mb-3" name="password_confirm" id="password_confirm" placeholder="Confirm your password here" value="">
            </div>
           </div>
           <!--
           <div class="col-md-6">
