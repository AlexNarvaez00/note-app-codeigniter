...
<?= link_tag('cork/src/assets/css/light/users/user-profile.css') ?>

<?= link_tag('cork/src/assets/css/dark/components/list-group.css') ?>
<?= link_tag('cork/src/assets/css/dark/users/user-profile.css') ?>
<?= $this->endSection() ?>
<!--END STYLES-->
  ...
  <div class="user-profile">
   <div class="widget-content widget-content-area">
    <div class="d-flex justify-content-between">
     <h3 class="">Profile</h3>
     <a href="<?= str_replace('index.php/', '', url_to('Profile::edit/$1', auth()->getUser()->id)) ?>" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
     ...
     <div class="">
      <ul class="contacts-block list-unstyled">
       ...
       <li class="contacts-block__item">
        ...
        </svg>Last Update, <?= date('d M Y', strtotime($profile['updated_at']))  ?>
       </li>
       ...
       <li class="contacts-block__item">
        ...
        </svg> <?= $profile['cellphone'] ?>
       </li>
      </ul>

      <ul class="list-inline mt-4">
       <li class="list-inline-item mb-0">
        <a class="btn btn-info btn-icon btn-rounded" href="<?= $profile['twitter_link'] ?>">
       ...
       <li class="list-inline-item mb-0">
        <a class="btn btn-dark btn-icon btn-rounded" href="<?= $profile['github_link'] ?>">
